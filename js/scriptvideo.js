...
//DESCARGAR DE CATALOGO
function downloadAndReload() {
  // Descargar el archivo
  var link = document.createElement('a');
  link.href = "catalogo/instalador.zip";
...
window.addEventListener('scroll', function() {
  ...
  var adContainerPosition = adContainer.getBoundingClientRect().top;
  var windowHeight = window.innerHeight;

  if (adContainerPosition < windowHeight) {
    adContainer.classList.add('animate-in');
  }
});
